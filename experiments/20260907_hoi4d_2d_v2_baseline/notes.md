...
**Result:** best val/loss_total **0.3842** (epoch 88); held-out (110 objects): mIoU **0.716**, PDet **88.2**, point err 0.0144, traj proj-2D shape 0.0398 (all categories now), traj_dir acc 48.1 (chance). plain head ties on masks/points (+1.7 PDet) but the smooth basis buys shape (0.0398 vs 0.0379) — DCT kept. Three-way: dct_baseline 0.720/86.5/0.0379, baseline 0.716/88.2/0.0398, teacher_forcing 0.727/88.0/0.0377 — statistically tied.
