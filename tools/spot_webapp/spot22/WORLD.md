...
The EgoArt web app (`tools/spot_webapp/server.py` on the Mac) draws its predictions, base goal and hand waypoints into this view under `world/egoart/<stage>` via `rr_egoart.py`; the app's reset clears them.
