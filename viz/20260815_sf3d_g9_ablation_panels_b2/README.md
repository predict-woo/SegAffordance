# 20260815_sf3d_g9_ablation_panels_b2 — supervision-ablation 3-arm comparison
...
/opt/venv/bin/python tools/sf3d_vis_predictions.py \
  ...
  --num 16 --seed 42421 --out viz/20260815_sf3d_g9_ablation_panels_b2
```

Interpretation: b2 re-render of the same 16 samples after the viz-tool change
that skips the GT-trajectory overlay (and trims the legend) on
trajectory-less arms — arm B panels now show only mask, axis, orbit and
origin ring (user decision 2026-08-15: the GT track was confusing there).
