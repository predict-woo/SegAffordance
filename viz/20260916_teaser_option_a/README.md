...
"open the laptop screen"): the raw frame with the instruction; the prior methods as a scattered pile
(3DOI on top, its blob mask and sideways line an obvious miss; A3VLM, OPDFormer-C, MOPD, OPDFormer-P
tossed behind at their own offsets and angles, all "prismatic" with a missing part) under one cross; EgoArt (`20260913_joint4_decoder_l2anchor_dense`, best-epoch13) under a check: revolute, full
