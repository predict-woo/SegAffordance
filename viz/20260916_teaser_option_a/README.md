...
"open the laptop screen"): the raw frame with the instruction; the prior methods as a fanned stack
(front to back OPDFormer-P, 3DOI, A3VLM, OPDFormer-C, MOPD, all "prismatic" with a missing part) under
one cross; EgoArt (`20260913_joint4_decoder_l2anchor_dense`, best-epoch13) under a check: revolute, full
