#!/bin/bash
# Pod cfl22pi (2026-09-11): position L2 alone at sweep 2pi (same pipeline as the
# August cf arms: sweep_queue stages SF3D into /dev/shm, trains, keeps the best ckpt) -> test.
# Markers: QUEUE_DONE (from sweep_queue), CF_L2_2PI_DONE, CHAIN_DONE.
...
E=20260911_sf3d_cf_l2_noaxis_2pi; CFG=config/sf3d_train_runpod_cf_l2_noaxis_2pi.yaml
...
echo "CF_L2_2PI_DONE $(date)"; echo "CHAIN_DONE $(date)"
