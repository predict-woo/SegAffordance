...
# Markers: QUEUE_DONE (from sweep_queue), CF_FRAME_A3_DONE, CHAIN_DONE.
...
E=20260911_sf3d_cf_frame_a3; CFG=config/sf3d_train_runpod_cf_frame_a3.yaml
...
echo "CF_FRAME_A3_DONE $(date)"; echo "CHAIN_DONE $(date)"
