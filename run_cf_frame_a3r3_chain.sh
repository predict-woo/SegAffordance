#!/bin/bash
# Pod cfframea3 (2026-09-11 night): cf_frame with axis:phase 3:1 (same pipeline as the
# August cf arms: sweep_queue stages SF3D into /dev/shm, trains, keeps the best ckpt) -> test.
# Markers: QUEUE_DONE (from sweep_queue), CF_FRAME_A3R3_DONE, CHAIN_DONE.
...
E=20260911_sf3d_cf_frame_a3r3; CFG=config/sf3d_train_runpod_cf_frame_a3r3.yaml
...
echo "CF_FRAME_A3R3_DONE $(date)"; echo "CHAIN_DONE $(date)"
